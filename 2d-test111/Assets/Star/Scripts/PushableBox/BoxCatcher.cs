...
namespace Gamekit2D
{
    public class BoxCatcher : MonoBehaviour
    {
        ...
        protected BoxCatcher m_ParentCatcher;
        ...
        void Awake()
        {
            ...
            {
                BoxCatcher catcher = currentParent.GetComponent<BoxCatcher>();
                if (catcher != null)
        ...
        void CheckRigidbodyContacts(Rigidbody2D rb)
        {
            ...
            for (int j = 0; j < contactCount; j++)
            {
                ...
                Rigidbody2D contactRigidbody = contactPoint2D.rigidbody == rb
        ...
        public void MoveCaughtObjects(Vector2 velocity)
        {
            ...
            {
                CaughtObject caughtObject = m_CaughtObjects[i];
                if (m_ParentCatcher != null && m_ParentCatcher.m_CaughtObjects.Find((CaughtObject A) =>
                    {
